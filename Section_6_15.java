/*
(Financial application: print a tax table) Listing 3.5 gives a program to compare tax. Write a method for computing tax using the following header:
public static double computeTex(int status, double taxableIncome)
Use this method to write a program that prints a tax table for taxable income from $50.000 to $70.000 with intervals of $100 for all the following statuses:
Taxable     Single      Married Joint       Married Separate        Head of
Income                  or Qualifying                               a house
                        Widow(er)
...
public class Section_6_15 {
    ...
    public static void main(String[] args) {
        // Print table header
        System.out.printf("%-12s%-12s%-16s%-20s%-15s%n", "Taxable", "Single", "Married Joint or Qualifying Widower", "Married Separate", "Head of House");
        System.out.println("--------------------------------------------------------------------------");

        // Loop for taxable income from $50,000 to $70,000 in increments of $100
        for (int income = 50000; income <= 70000; income += 100) {
            System.out.printf("%-12d%-12.2f%-16.2f%-20.2f%-15.2f%n",
                    income,
                    computeTax(0, income), // Single
                    computeTax(1, income), // Married Joint
                    computeTax(2, income), // Married Separate
                    computeTax(3, income)); // Head of House
        }
    }
}
